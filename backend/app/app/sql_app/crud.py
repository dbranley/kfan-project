...
async def get_my_favorite_photo_cards_bkup(database: Database, user_id: int, my_cards: bool, skip: int=0, limit: int=100):
     print("crud.get_my_favorite_photo_cards_bkup() - at top")
